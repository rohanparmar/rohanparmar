...
const HeroContent = () => {
  return (
    <motion.div 
      initial="hidden" 
      animate="visible" 
      className='flex flex-col items-center justify-center px-4 md:px-20 mt-20 md:mt-20 w-full h-screen z-[20]'
    >
        ...
        >
          ...
          >
            ...
            <p className='text-sm md:text-lg text-white/80 leading-relaxed pl-4'>
              Computer Science student at Simon Fraser University with a focus on Machine Learning and Full Stack Development. 
              Currently building AI-powered tools and applications to solve real-world problems.
            </p>
          </motion.div>
        </motion.div>
